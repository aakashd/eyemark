...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\eyemark on
     Windows, /home/user/dev/eyemark on Linux) in a file named
     eyemark@aakash.dharmadhikari and copy that file to
